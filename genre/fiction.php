  ...
  <script
    ...
    <div id="login-box" class="animate">
      ...
      <div class="jumbotron jumbotron-fluid">
        ...
        <div id="first_book">
            <div class="image">
                <img src="img/fiction1.png">
            </div>
            <div class="title" style='color:black;font-size:250%;'>
                <b>  Harry Porter and Chamber of Secrets</b>
            </div>
            <div class="author" style='color:black;font-size:200%;'>
                J.K Rowling
            </div>
            <div class="cost" style='color:black;font-size:200%;'>
                Rs. 2000
            </div>
