...
<?php
    ...
    echo "<br>";
    $query="SELECT * FROM `user` INNER JOIN `location` ON `user`.user_id = `location`.user_id";
    echo "<br>";
    function create_new_id($q, $ab , $cd , $ef , $gh , $ij, $ku, $mer, $ert , $ghy , $mnb , $ire , $rtu , $yuio)
    {
        $x=$ab;
        $y=$cd;
        $z=$ef;
        ...
        $www=$rtu.$q;
        $qqq=$yuio.$q;
        $id_new = array($x,$y,$z,$u,$iop,$ytr,$tre,$yui,$dse,$zzz,$ooo,$www,$qqq);
        $x=$y=$u=$z=$iop=$ytr=$tre=$yui=$dse=$zzz=$ooo=$www=$qqq=0;
        return $id_new;
    }
    if($result=mysqli_query($link,$query))
    {
        ...
        while($row=mysqli_fetch_array($result))
        {
            if($ert==0)
            {
                ...
                $id= array("id","name","email","phone","table","block","unblock","block_users","unblock_users","image" , "building","street_name","city");
                $ert=1;
                $ytru=create_new_id("$ert","$id[0]","$id[1]","$id[2]","$id[3]","$id[4]","$id[5]","$id[6]","$id[7]","$id[8]","$id[9]" , "$id[10]","$id[11]","$id[12]");
                $med1=$ytru;
                //$med2=$med[1];
                $ert=1;
            }
            if($ert==1)
            {
                ...
                $g=$row[10];
                $id= $med1;
                $query1="SELECT `title`, `author` ,`price` FROM `dashboard1` WHERE sell_id='$a'";
                ...
                echo "<div id='user_display'>
                        ...
                        <div id='user_information'>
                            ...
                            <p id='$id[10]' style='color:whitesmoke;font-family: Times New Roman, Times, serif;font-weight: bolder;font-size:100%;text-align:center;font-style:italic;'></p>
                            <p id='$id[11]' style='color:whitesmoke;font-family: Times New Roman, Times, serif;font-weight: bolder;font-size:100%;text-align:center;font-style:italic;'></p>
                            <p id='$id[12]' style='color:whitesmoke;font-family: Times New Roman, Times, serif;font-weight: bolder;font-size:100%;text-align:center;font-style:italic;'></p>
                        </div>
                    ...
                    echo "<form method='post' id='banner'>
                            <input type='submit' name='$id[5]' id='$id[7]' value='Click To block the particular user' style='width:300px;
                            height:50px;
                            border-style: solid;
                            margin-left:10px;
                            border-radius: 8px;
                    ...
                    echo "<form method='post' id='banner'>
                            <input type='submit' name='$id[6]' id='$id[8]' value='Click To Unblock the particular user' style='width:300px;
                            height:50px;
                            border-style: solid;
                            margin-right:10px;
                            border-radius: 8px;
                ...
                echo "<script>
                    ...
                    document.getElementById('$id[10]').innerHTML='Name of the Building of the user residence'+' '+'$e'+'.';
                    document.getElementById('$id[11]').innerHTML='Nmae of the Street of the user residence'+' '+'$f'+'.';
                    document.getElementById('$id[12]').innerHTML='City in which the user lives'+' '+'$g'+'.';
                </script>";
                $med1=create_new_id($wer , $id[0] , $id[1], $id[2] , $id[3] , $id[4], $id[5] , $id[6], $id[7], $id[8], $id[9] , $id[10] , $id[11], $id[12]);
        }
        echo "<hr>";
        echo "<br>";echo "<br>";
